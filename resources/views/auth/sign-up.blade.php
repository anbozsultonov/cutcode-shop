...
@section('tytle', 'Регистрация')

@section('content')
    <main class="md:min-h-screen md:flex md:items-center md:justify-center py-16 lg:py-20">
        <div class="container">
            <x-forms.auth-forms title="Регистрация" action="{{route('storeUser')}}" method="POST">
                @csrf
                ...
                <x-forms.text-input :isError="$errors->has('password_confirmation')"
                ...
                <x-slot:socialAuth>
                    <ul class="space-y-3 my-2">
                        <li>
                            <a href="{{route('socialite', ['driver' => config('auth.socialite_drivers.github')])}}"
